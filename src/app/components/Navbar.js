    ...
    <div>
      <header className={`bg-b2 shadow-md py-4 px-8 font-roboto ${isFormVisible ? "blur-sm" : ""}`}> {/* Highlighted line */}
        <div className="container mx-auto flex justify-between items-center">
          {/* Title */}
          <div className="text-3xl font-roboto font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-800">
        <Link href="/">FundChain</Link>
          ...
          <Link href="/about" className="bg-b3   px-4 py-2 rounded-md hover:bg-b1">
                    About 
            </Link>
            <button onClick={() => setIsFormVisible(true)} className="bg-b3  px-4 py-2 rounded-md hover:bg-b1">
              Create Campaign
            </button>
            <div onClick={connectWallet} className="bg-b3  px-4 py-2 rounded-md hover:bg-b1 cursor-pointer">
          ...
          <div className="bg-white p-8 rounded-md shadow-md z-50 max-w-lg w-full">
            ...
            <form onSubmit={createCampaign}>
              ...
              <div className="flex items-center justify-between">
                <button  className="bg-b3 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
                  Submit
                </button>
                <button onClick={() => setIsFormVisible(false)} className="inline-block align-baseline font-bold text-sm text-b3 hover:text-blue-800">
                  Cancel
                </button>
              </div>
            </form>
