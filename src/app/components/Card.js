...
export default function Card({ image, title, description, fundLink, statsLink, onFundClick }) {
  return (
    <div className="w-[60vw] h-[40vh] bg-b1 shadow-lg font-roboto rounded-lg overflow-hidden flex flex-col my-7">
      {/* Card Content */}
